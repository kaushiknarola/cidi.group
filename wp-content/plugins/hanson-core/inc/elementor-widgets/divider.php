...
class Widget_Ithemeslab_Divider extends Widget_Base {
	...
	public function get_title() {
		return __( 'ITL - Divider', 'elementor' );
	}
...
Plugin::instance()->widgets_manager->register_widget_type( new Widget_Ithemeslab_Divider() );