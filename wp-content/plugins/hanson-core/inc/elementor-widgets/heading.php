...
class Widget_Ithemeslab_Heading extends Widget_Base {
	...
	public function get_title() {
		return __( 'ITL - Heading', 'elementor' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'title_second_color',
			[
				'label' => __( 'Heading Second Color', 'elementor' ),
				'type' => Controls_Manager::COLOR,
				'default' => '#1bbde8',
				'selectors' => [
...
Plugin::instance()->widgets_manager->register_widget_type( new Widget_Ithemeslab_Heading() );