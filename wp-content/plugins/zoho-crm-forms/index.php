...
if (!defined('ABSPATH'))
	...
	return $url;
     ...
     function zcf_configfilesInclude() {
        ...
        $uciPages = array('crmforms-builder', 'formsettings-builder', 'lb-crmconfig','formsubmit-logs');
        require_once("includes/crmwebformsfieldsmapping.php");
        require_once("includes/crmcontactforminte.php");
    ...
    function zcf_plugin_assets() {
        $pages_list = array('crmforms-builder', 'formsettings-builder', 'create-thirdpartyform-builder', 'create-leadform-builder', 'create-contactform-builder', 'zoho-crm-form-builder','formsubmit-logs');
...
function zcf_tab3customdisplay() {
    $nonunce = wp_create_nonce( "create-leadform-builder");
    $content = "<input id='crm-ajax-nonce' type='hidden'  value='$nonunce' name='create-leadform-builder' />";
    echo $content;
}
